...
CREATE TABLE restaurants (id BIGSERIAL PRIMARY KEY NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, province VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, postalcode VARCHAR(255) NOT NULL, longtitude VARCHAR(255) NOT NULL, latitude VARCHAR(255) NOT NULL, priceRange INT NOT NULL check(priceRange >= 1 and priceRange <= 5));
